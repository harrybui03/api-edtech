...
INSERT INTO courses (
    ...
    skill_level, learner_profile_desc
      ...
      (course_ids[1], 'Mastering Spring Boot 3', 'mastering-spring-boot-3', 'A comprehensive guide to building modern applications.', 'Covers dependency injection, microservices, security, and testing.', 'spring-boot-3.jpg', NULL, 'PUBLISHED', TRUE, 99.99, 79.99, 'USD', 79.99, 1500, 45, 4.85, 'English', 'Backend Developers', 'Advanced', 'Professionals looking to master the latest Spring Boot features.'),
      (course_ids[2], 'Introduction to PostgreSQL', 'introduction-to-postgresql', 'Learn the fundamentals of the world''s most advanced open source database.', 'SQL basics, data types, and simple queries for beginners.', 'postgresql-intro.jpg', NULL, 'PUBLISHED', TRUE, 49.99, 29.99, 'USD', 29.99, 850, 20, 4.60, 'English', 'Data Analysts and Beginners', 'Beginner', 'Anyone starting their journey with SQL and relational databases.'),
      (course_ids[3], 'Advanced Docker and Kubernetes', 'advanced-docker-kubernetes', 'Deploy and manage containerized applications at scale.', 'Deep dive into orchestration, networking, and storage.', 'docker-k8s.jpg', NULL, 'PUBLISHED', TRUE, 149.99, 119.99, 'USD', 119.99, 1200, 60, 4.90, 'English', 'DevOps Engineers', 'Expert', 'Experienced users seeking to deploy and manage large-scale systems.'),
      (course_ids[4], 'React for Beginners', 'react-for-beginners', 'Build modern, interactive user interfaces with React.', 'Learn components, state, props, and hooks from scratch.', 'react-beginners.jpg', NULL, 'PUBLISHED', TRUE, 79.99, 59.99, 'USD', 59.99, 2100, 35, 4.75, 'English', 'Front-end Developers', 'Beginner', 'Aspiring web developers and designers who want to learn React.'),
      (course_ids[5], 'Data Structures and Algorithms in Java', 'data-structures-algorithms-java', 'Master the essential concepts for coding interviews.', 'Covers arrays, linked lists, trees, graphs, and sorting algorithms.', 'dsa-java.jpg', NULL, 'PUBLISHED', TRUE, 89.99, 69.99, 'USD', 69.99, 900, 50, 4.80, 'English', 'Software Engineers', 'Intermediate', 'Individuals preparing for technical interviews or strengthening their fundamentals.'),
      (course_ids[6], 'Building RESTful APIs with Node.js', 'restful-apis-nodejs', 'Create fast and scalable backend services.', 'Using Express.js, MongoDB, and best practices.', 'nodejs-api.jpg', NULL, 'DRAFT', TRUE, 69.99, 49.99, 'USD', 49.99, 0, 0, 0.00, 'English', 'Backend Developers', 'Intermediate', 'Developers who want to build modern, production-ready APIs.'),
      (course_ids[7], 'Machine Learning with Python', 'machine-learning-python', 'An introduction to practical machine learning.', 'Using Scikit-learn, Pandas, and NumPy.', 'ml-python.jpg', NULL, 'DRAFT', TRUE, 129.99, 99.99, 'USD', 99.99, 0, 0, 0.00, 'English', 'Data Scientists', 'Intermediate', 'Anyone looking to apply machine learning models to real-world data.'),
      (course_ids[8], 'CSS Grid and Flexbox', 'css-grid-flexbox', 'Modern CSS layout techniques explained.', 'Build complex, responsive layouts with ease.', 'css-layout.jpg', NULL, 'DRAFT', TRUE, 39.99, 19.99, 'USD', 19.99, 0, 0, 0.00, 'English', 'Front-end Developers', 'Beginner', 'Web developers struggling with traditional layout methods.'),
      (course_ids[9], 'Go (Golang) Programming', 'go-programming-basics', 'Learn the basics of Google''s Go language.', 'Concurrency, channels, and building simple web servers.', 'golang-basics.jpg', NULL, 'DRAFT', TRUE, 79.99, 59.99, 'USD', 59.99, 0, 0, 0.00, 'English', 'System Engineers', 'Beginner', 'Developers looking to learn a fast, concurrent, and modern language.'),
      (course_ids[10], 'Introduction to Cloud Computing', 'intro-to-cloud-computing', 'Understand the fundamentals of AWS, Azure, and GCP.', 'Virtual machines, storage, and serverless computing.', 'cloud-intro.jpg', NULL, 'DRAFT', TRUE, 59.99, 39.99, 'USD', 39.99, 0, 0, 0.00, 'English', 'IT Professionals', 'Beginner', 'Anyone who needs a solid understanding of cloud service models and providers.'),
      (course_ids[11], 'Vue.js 3 Fundamentals', 'vuejs-3-fundamentals', 'Build reactive front-end applications with Vue.', 'Composition API, Vuex, and Vue Router.', 'vuejs-3.jpg', NULL, 'DRAFT', TRUE, 79.99, 59.99, 'USD', 59.99, 0, 0, 0.00, 'English', 'Front-end Developers', 'Intermediate', 'Developers with basic JavaScript knowledge ready to learn a reactive framework.'),
      (course_ids[12], 'Advanced SQL Techniques', 'advanced-sql-techniques', 'Master window functions, CTEs, and query optimization.', 'For data analysts and backend developers.', 'advanced-sql.jpg', NULL, 'DRAFT', TRUE, 99.99, 79.99, 'USD', 79.99, 0, 0, 0.00, 'English', 'Data Analysts and Backend Developers', 'Advanced', 'Users of SQL who want to write more efficient and complex queries.'),
      (course_ids[13], 'Test-Driven Development (TDD) in C#', 'tdd-in-csharp', 'Write robust and maintainable code with TDD.', 'Using NUnit and Moq.', 'tdd-csharp.jpg', NULL, 'DRAFT', TRUE, 89.99, 69.99, 'USD', 69.99, 0, 0, 0.00, 'English', 'Software Engineers', 'Intermediate', 'C# developers aiming to improve code quality and testing practices.'),
      (course_ids[14], 'Introduction to UI/UX Design', 'intro-to-ui-ux-design', 'Principles of user-centric design.', 'Wireframing, prototyping, and user testing.', 'ui-ux-intro.jpg', NULL, 'DRAFT', TRUE, 69.99, 49.99, 'USD', 49.99, 0, 0, 0.00, 'English', 'Designers and Developers', 'Beginner', 'Anyone interested in the process of creating user-friendly digital products.'),
      (course_ids[15], 'Cybersecurity Fundamentals', 'cybersecurity-fundamentals', 'Protecting systems from common threats.', 'Network security, cryptography, and ethical hacking.', 'cybersecurity.jpg', NULL, 'DRAFT', TRUE, 119.99, 89.99, 'USD', 89.99, 0, 0, 0.00, 'English', 'IT Professionals', 'Intermediate', 'Individuals who want a foundational understanding of digital security.'),
      (course_ids[16], 'GraphQL for API Development', 'graphql-for-api-dev', 'Build flexible and efficient APIs with GraphQL.', 'Compared to REST, with Apollo Server.', 'graphql-api.jpg', NULL, 'DRAFT', TRUE, 79.99, 59.99, 'USD', 59.99, 0, 0, 0.00, 'English', 'Backend Developers', 'Intermediate', 'Developers transitioning from REST to modern API technologies.'),
      (course_ids[17], 'Getting Started with Rust', 'getting-started-with-rust', 'Learn the basics of the Rust programming language.', 'Ownership, borrowing, and lifetimes.', 'rust-basics.jpg', NULL, 'DRAFT', TRUE, 89.99, 69.99, 'USD', 69.99, 0, 0, 0.00, 'English', 'Systems Programmers', 'Beginner', 'Developers interested in high-performance, safe systems programming.'),
      (course_ids[18], 'DevOps CI/CD with Jenkins', 'devops-cicd-jenkins', 'Automate your build and deployment pipeline.', 'Jenkinsfiles, plugins, and best practices.', 'jenkins-cicd.jpg', NULL, 'DRAFT', TRUE, 99.99, 79.99, 'USD', 79.99, 0, 0, 0.00, 'English', 'DevOps Engineers', 'Intermediate', 'Professionals looking to implement and manage automated delivery pipelines.'),
      (course_ids[19], 'Mobile App Development with Flutter', 'mobile-app-dev-flutter', 'Build cross-platform apps from a single codebase.', 'Dart, widgets, and state management.', 'flutter-mobile.jpg', NULL, 'DRAFT', TRUE, 109.99, 89.99, 'USD', 89.99, 0, 0, 0.00, 'English', 'Mobile Developers', 'Intermediate', 'Developers aiming to build native-quality apps for iOS and Android quickly.'),
      (course_ids[20], 'The Complete Guide to Web Scraping', 'complete-guide-web-scraping', 'Extract data from websites using Python.', 'Beautiful Soup, Scrapy, and handling dynamic sites.', 'web-scraping.jpg', NULL, 'DRAFT', TRUE, 79.99, 59.99, 'USD', 59.99, 0, 0, 0.00, 'English', 'Data Engineers', 'Intermediate', 'Anyone who needs to collect and process data from the public web.');
