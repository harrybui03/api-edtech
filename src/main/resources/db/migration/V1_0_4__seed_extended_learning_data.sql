...
BEGIN
    ...
    -- Note: 'position' column is removed.
    INSERT INTO chapters (id, course_id, title, summary) VALUES
    (chapter_ids[1], course_ids[1], 'Chapter 1: Spring Core', 'The fundamentals of Spring.'),
    (chapter_ids[2], course_ids[1], 'Chapter 2: Web Layer', 'Building web applications.'),
    (chapter_ids[3], course_ids[1], 'Chapter 3: Data Access', 'Connecting to databases.'),
    (chapter_ids[4], course_ids[1], 'Chapter 4: Security', 'Securing your application.'),
    (chapter_ids[5], course_ids[2], 'Chapter 1: SQL Basics', 'SELECT, FROM, WHERE.'),
    (chapter_ids[6], course_ids[2], 'Chapter 2: Joins', 'INNER, LEFT, RIGHT joins.'),
    (chapter_ids[7], course_ids[2], 'Chapter 3: Aggregation', 'GROUP BY, COUNT, SUM.'),
    (chapter_ids[8], course_ids[2], 'Chapter 4: Data Types', 'Understanding text, numbers, and dates.'),
    (chapter_ids[9], course_ids[3], 'Chapter 1: Docker Basics', 'Images and Containers.'),
    (chapter_ids[10], course_ids[3], 'Chapter 2: Docker Compose', 'Multi-container applications.'),
    (chapter_ids[11], course_ids[3], 'Chapter 3: Kubernetes Intro', 'Pods, Services, Deployments.'),
    (chapter_ids[12], course_ids[3], 'Chapter 4: Helm Charts', 'Packaging Kubernetes applications.'),
    (chapter_ids[13], course_ids[4], 'Chapter 1: JSX and Components', 'Building blocks of React.'),
    (chapter_ids[14], course_ids[4], 'Chapter 2: State and Props', 'Managing data flow.'),
    (chapter_ids[15], course_ids[4], 'Chapter 3: Handling Events', 'User interactions.'),
    (chapter_ids[16], course_ids[4], 'Chapter 4: Hooks', 'useState and useEffect.'),
    (chapter_ids[17], course_ids[5], 'Chapter 1: Arrays & Strings', 'Fundamental data structures.'),
    (chapter_ids[18], course_ids[5], 'Chapter 2: Linked Lists', 'Singly and Doubly linked lists.'),
