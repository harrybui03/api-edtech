...
BEGIN
    ...
    (course_ids[8], 'CSS Grid and Flexbox', 'css-grid-flexbox', 'Modern CSS layout techniques explained.', 'Build complex, responsive layouts with ease.', 'IN_PROGRESS', 'English', 39.99, 19.99),
    (course_ids[9], 'Go (Golang) Programming', 'go-programming-basics', 'Learn the basics of Google''s Go language.', 'Concurrency, channels, and building simple web servers.', 'IN_PROGRESS', 'English', 79.99, 59.99),
    (course_ids[10], 'Introduction to Cloud Computing', 'intro-to-cloud-computing', 'Understand the fundamentals of AWS, Azure, and GCP.', 'Virtual machines, storage, and serverless computing.', 'IN_PROGRESS', 'English', 59.99, 39.99),
    (course_ids[11], 'Vue.js 3 Fundamentals', 'vuejs-3-fundamentals', 'Build reactive front-end applications with Vue.', 'Composition API, Vuex, and Vue Router.', 'IN_PROGRESS', 'English', 79.99, 59.99),
    (course_ids[12], 'Advanced SQL Techniques', 'advanced-sql-techniques', 'Master window functions, CTEs, and query optimization.', 'For data analysts and backend developers.', 'IN_PROGRESS', 'English', 99.99, 79.99),
    (course_ids[13], 'Test-Driven Development (TDD) in C#', 'tdd-in-csharp', 'Write robust and maintainable code with TDD.', 'Using NUnit and Moq.', 'IN_PROGRESS', 'English', 89.99, 69.99),
    (course_ids[14], 'Introduction to UI/UX Design', 'intro-to-ui-ux-design', 'Principles of user-centric design.', 'Wireframing, prototyping, and user testing.', 'IN_PROGRESS', 'English', 69.99, 49.99),
    (course_ids[15], 'Cybersecurity Fundamentals', 'cybersecurity-fundamentals', 'Protecting systems from common threats.', 'Network security, cryptography, and ethical hacking.', 'IN_PROGRESS', 'English', 119.99, 89.99),
    (course_ids[16], 'GraphQL for API Development', 'graphql-for-api-dev', 'Build flexible and efficient APIs with GraphQL.', 'Compared to REST, with Apollo Server.', 'IN_PROGRESS', 'English', 79.99, 59.99),
    (course_ids[17], 'Getting Started with Rust', 'getting-started-with-rust', 'Learn the basics of the Rust programming language.', 'Ownership, borrowing, and lifetimes.', 'IN_PROGRESS', 'English', 89.99, 69.99),
    (course_ids[18], 'DevOps CI/CD with Jenkins', 'devops-cicd-jenkins', 'Automate your build and deployment pipeline.', 'Jenkinsfiles, plugins, and best practices.', 'IN_PROGRESS', 'English', 99.99, 79.99),
    (course_ids[19], 'Mobile App Development with Flutter', 'mobile-app-dev-flutter', 'Build cross-platform apps from a single codebase.', 'Dart, widgets, and state management.', 'IN_PROGRESS', 'English', 109.99, 89.99),
    (course_ids[20], 'The Complete Guide to Web Scraping', 'complete-guide-web-scraping', 'Extract data from websites using Python.', 'Beautiful Soup, Scrapy, and handling dynamic sites.', 'IN_PROGRESS', 'English', 79.99, 59.99);
    ...
    -- Lessons with video only
    (lesson_ids[17], chapter_ids[9], course_ids[3], 'Lesson 1.1: What is a Container?', 'docker-container', NULL, 1, NULL, 'https://example.com/videos/docker-container.mp4'),
    (lesson_ids[18], chapter_ids[9], course_ids[3], 'Lesson 1.2: Dockerfile Basics', 'docker-dockerfile', NULL, 2, NULL, 'https://example.com/videos/docker-dockerfile.mp4'),
    (lesson_ids[19], chapter_ids[10], course_ids[3], 'Lesson 2.1: docker-compose.yml', 'docker-compose-file', NULL, 1, NULL, 'https://example.com/videos/docker-compose-file.mp4'),
    (lesson_ids[20], chapter_ids[10], course_ids[3], 'Lesson 2.2: Networking', 'docker-compose-networking', NULL, 2, NULL, 'https://example.com/videos/docker-compose-networking.mp4'),
    (lesson_ids[21], chapter_ids[11], course_ids[3], 'Lesson 3.1: Pods', 'k8s-pods', NULL, 1, NULL, 'https://example.com/videos/k8s-pods.mp4'),
    (lesson_ids[22], chapter_ids[11], course_ids[3], 'Lesson 3.2: Services', 'k8s-services', NULL, 2, NULL, 'https://example.com/videos/k8s-services.mp4'),
    (lesson_ids[23], chapter_ids[12], course_ids[3], 'Lesson 4.1: What is Helm?', 'helm-intro', NULL, 1, NULL, 'https://example.com/videos/helm-intro.mp4'),
    (lesson_ids[24], chapter_ids[12], course_ids[3], 'Lesson 4.2: Creating a Chart', 'helm-create-chart', NULL, 2, NULL, 'https://example.com/videos/helm-create-chart.mp4'),
    (lesson_ids[25], chapter_ids[13], course_ids[4], 'Lesson 1.1: Functional Components', 'react-functional-components', NULL, 1, NULL, 'https://example.com/videos/react-functional-components.mp4'),
    (lesson_ids[26], chapter_ids[13], course_ids[4], 'Lesson 1.2: Class Components', 'react-class-components', NULL, 2, NULL, 'https://example.com/videos/react-class-components.mp4'),
    (lesson_ids[27], chapter_ids[14], course_ids[4], 'Lesson 2.1: Lifting State Up', 'react-lifting-state', NULL, 1, NULL, 'https://example.com/videos/react-lifting-state.mp4'),
    (lesson_ids[28], chapter_ids[14], course_ids[4], 'Lesson 2.2: Props Drilling', 'react-props-drilling', NULL, 2, NULL, 'https://example.com/videos/react-props-drilling.mp4'),
    (lesson_ids[29], chapter_ids[15], course_ids[4], 'Lesson 3.1: onClick', 'react-onclick', NULL, 1, NULL, 'https://example.com/videos/react-onclick.mp4'),
    (lesson_ids[30], chapter_ids[15], course_ids[4], 'Lesson 3.2: onChange', 'react-onchange', NULL, 2, NULL, 'https://example.com/videos/react-onchange.mp4'),
    (lesson_ids[31], chapter_ids[16], course_ids[4], 'Lesson 4.1: useState', 'react-usestate', NULL, 1, NULL, 'https://example.com/videos/react-usestate.mp4'),
    (lesson_ids[32], chapter_ids[16], course_ids[4], 'Lesson 4.2: useEffect', 'react-useeffect', NULL, 2, NULL, 'https://example.com/videos/react-useeffect.mp4'),
    -- Lessons with quiz only
    (lesson_ids[33], chapter_ids[17], course_ids[5], 'Lesson 1.1: Big O Notation', 'big-o-notation', NULL, 1, quiz_ids[17], NULL),
    (lesson_ids[34], chapter_ids[17], course_ids[5], 'Lesson 1.2: Dynamic Arrays', 'dynamic-arrays', NULL, 2, quiz_ids[18], NULL),
    (lesson_ids[35], chapter_ids[18], course_ids[5], 'Lesson 2.1: List Operations', 'linked-list-ops', NULL, 1, quiz_ids[19], NULL),
    (lesson_ids[36], chapter_ids[18], course_ids[5], 'Lesson 2.2: Runner Technique', 'linked-list-runner', NULL, 2, quiz_ids[20], NULL),
    (lesson_ids[37], chapter_ids[19], course_ids[5], 'Lesson 3.1: Traversal', 'tree-traversal', NULL, 1, NULL, NULL),
    (lesson_ids[38], chapter_ids[19], course_ids[5], 'Lesson 3.2: Insertion', 'tree-insertion', NULL, 2, NULL, NULL),
    (lesson_ids[39], chapter_ids[20], course_ids[5], 'Lesson 4.1: Merge Sort', 'merge-sort', NULL, 1, NULL, NULL),
    (lesson_ids[40], chapter_ids[20], course_ids[5], 'Lesson 4.2: Quick Sort', 'quick-sort', NULL, 2, NULL, NULL);
